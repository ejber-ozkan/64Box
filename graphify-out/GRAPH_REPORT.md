...
## Corpus Check
- 155 files · ~91,443 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1427 nodes · 2689 edges · 96 communities (85 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 44 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0646e96f`
...
Cohesion: 0.11
Nodes (21): DETAIL_CONFIG, DetailFullscreenMedia, DetailViewProps, GridViewProps, ImageSlider(), ImageSliderProps, ListViewProps, ScrapeButtonProps (+13 more)
...
Cohesion: 0.13
Nodes (19): BigBoxViewProps, PlatformSwitcher(), PlatformSwitcherProps, Settings, LETTER_RAIL_CACHE, UseBigBoxLibraryDataProps, LibraryViewMode, UseLibraryShellInputProps (+11 more)
...
Cohesion: 0.14
Nodes (19): LibraryApp(), AlphabetJumpBar(), AlphabetJumpBarProps, LETTERS, AppLaunchSplash(), DetailView(), GridView(), ListView() (+11 more)
...
Cohesion: 0.07
Nodes (36): metadata, ERROR_SOUNDS, UiSoundRuntime(), defaultSettings, migratePlatformSettings(), PlatformImportStatusSnapshot, SECURE_FIELDS, SettingsContext (+28 more)
...
Cohesion: 0.19
Nodes (12): BigBoxFooter(), BigBoxFooterProps, BigBoxHeader(), BigBoxSessionState, BigBoxView(), BIGBOX_LETTERS, useBigBoxLibraryData(), useBigBoxNavigation() (+4 more)

### Community 96 - "Component 96"
Cohesion: 0.08
Nodes (48): getCoverUrl(), MusicianPhotoProps, COVER_ART_URL_CACHE, getResolvedCoverArtUrl(), ResolvedBoxArtGame, ActivePlatformStateResponse, DatabaseBootstrapStatus, DatabaseImportResult (+40 more)
...
- **Why does `import_platform_database_from_mdb()` connect `Component 7` to `Database & Performance Paradigms`?**
